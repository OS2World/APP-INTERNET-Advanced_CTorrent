...
//nick  uint8_t m_flag_reserved:7;	// current version not implement
  u_int8_t m_flag_readonly:1;   //nickk
  uint8_t m_flag_reserved:6;	// current version not implement
