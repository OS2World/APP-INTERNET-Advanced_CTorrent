...
//acw      char ih_buf[20 * 3 + 1];
//acw      char pi_buf[20 * 3 + 1];
//acw      char tmppath[MAXPATHLEN];
...
{
  char *event;
  char *str_event[] = {"started","stopped","completed" };
...
//                     (unsigned long long)m_totaldl,
                     (unsigned long long)((m_totalul = Self.TotalUL()) * fFakeUL),
                     (unsigned long long)(m_totaldl * fFakeDL),
